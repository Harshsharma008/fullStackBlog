...
//             <h1
//               className={`title-font sm:text-5xl text-5xl mb-4 text-white font-bold transition duration-700 ease-in-out ${startAnimation ? "transform scale-105 opacity-100" : "opacity-0"
//                 }`}
//             >
//               Vision
//             </h1>
...
//               <p
//                 className={`mb-8 w-50% text-white transition duration-1000 ease-in-out ${startAnimation ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
//                   }`}
//               >
...
//           </div>
//         </div>
//         <div className="container mx-auto px-5"> {/* Updated container to align with Vision */}
//           <Slider {...settings}>
//             {cardData.map((card, index) => (
//               <div key={index} className="flex flex-col items-center p-4 gap-2">
//                 <div className="border-2 border-gray-200 bg-white overflow-hidden border-opacity-60 rounded-xl h-64 w-64 flex flex-col justify-left items-left p-4">
